...
{
    public class SingleImageMissingCaptions : BaseCmsAdminTool
    {
        public override CmsAdminToolInfo getToolInfo()
        {
            return new CmsAdminToolInfo(CmsAdminToolCategory.Report_Image, AdminMenuTab.Reports, "Images without captions");
        }
