...
// source: http://www.heikniemi.net/hc/archives/000152.html

namespace Hatfield.Web.Portal.Data.Depricated
{

    /// <summary>
    /// A data-reader style interface for reading CSV files.
    /// this reader has problems with cells that contain \n or \r characters!!!
    /// </summary>
    public class CSVReader2 : IDisposable
    {
        ...
        public CSVReader2(Stream s) : this(s, null) { }
        ...
        public CSVReader2(Stream s, Encoding enc)
        {
        ...
        public CSVReader2(string filename) : this(filename, null) { }
        ...
        /// <param name="filename">The name of the file to be read.</param>
        /// <param name="enc">The encoding used.</param>
        public CSVReader2(string filename, Encoding enc)
            : this(new FileStream(filename, FileMode.Open), enc) { }


        public CSVReader2(System.Web.UI.HtmlControls.HtmlInputFile inputFileControl)
            : this(inputFileControl.PostedFile.InputStream)
        { }
        ...
        public DataSet WorkbookData
        {
            get
            {
                DataTable dataTable = ReadAllLines();
