...
var aattr = new Array();
aattr['a'] = ['href', 'name'];
aattr['table'] = ['border', 'bgcolor'];
aattr['th'] = ['colspan', 'rowspan'];
aattr['td'] = ['colspan', 'rowspan'];
aattr['img'] = ['src', 'width', 'height', 'alt', 'border'];
...
FCKCommands.RegisterCommand('nbsp', new My_FCKCleanHtmlCommand());

// Create the "nbsp" toolbar button.
var nbspItem = new FCKToolbarButton("nbsp", FCKLang.NbspButton);
nbspItem.IconPath = FCKConfig.PluginsPath + 'nbsp/cleantags.gif';
