...
namespace HatCMS.Controls._system.Internal
{
    public partial class FileLibraryCategoryPopup : System.Web.UI.UserControl
    {
        ...
        protected void addJavascript(CmsLanguage[] langArray, CmsPage page)
        {
            ...
            page.HeadSection.AddJavascriptFile("js/_system/FileLibrary/FileLibraryCategory.js");
        }
        ...
        /// <summary>
        /// Render the FileLibraryCaregory popup page
        /// </summary>
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            writer.Write(page.getFormStartHtml(controlId + "form") + EOL);
            writer.Write(PageUtils.getHiddenInputHtml(controlId + "id", controlId + "id", "") + EOL);
            writer.Write(PageUtils.getHiddenInputHtml(controlId + "delete", controlId + "delete", "") + EOL);
