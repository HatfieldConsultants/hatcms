...
<%
	...
	foreach(CmsPage g in galleryPage.ChildPages)
	{
		if (g.ShowInMenu)
		{
            ...
            CmsLocalImageOnDisk[] allResources = CmsLocalImageOnDisk.FetchAllFilesInDirectory(dirOnDiskToView, UserImageGalleryPlaceholderData.ImageExtensionsToDisplay);
