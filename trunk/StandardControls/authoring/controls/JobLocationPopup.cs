...
{
    public class JobLocationPopup : BaseCmsControl
    {
        ...
        protected void addJavascript(CmsLanguage[] langArray, CmsPage page)
        {
            ...
            page.HeadSection.AddJavascriptFile(JavascriptGroup.ControlOrPlaceholder, "js/_system/JobDatabase/JobLocation.js");
        }
