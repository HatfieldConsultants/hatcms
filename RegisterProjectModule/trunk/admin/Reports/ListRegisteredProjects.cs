...
{
    public class ListRegisteredProjects : BaseCmsAdminTool
    {
        public override CmsAdminToolInfo getToolInfo()
        {
            return new CmsAdminToolInfo(CmsAdminToolCategory.Report_Projects, AdminMenuTab.Reports, "List Registered Projects");
        }
        ...
        public override string Render()
        {
            ...
            html.Append("<caption><h2>Registered Projects <a style=\"font-size: small;\" href=\"" + CmsContext.ApplicationPath + "_system/tools/download.ashx?adminTool=ListRegisteredProjects\">(download Excel file)</a></h2></caption>");
            html.Append("<tr>");
        ...
        {
            return new RegisterProjectDb().fetchAllAsGrid();
        }
    }
}
