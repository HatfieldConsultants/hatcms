...
var My_FCKCleanHtmlCommand = function()
{	
}

My_FCKCleanHtmlCommand.prototype.Execute = function()
{
    // alert("Execute");
	d = window.FCK.EditorDocument.body.innerHTML;
	var output = cleanHTML();
	// alert(output);
	window.FCK.EditorDocument.body.innerHTML = output;
}
...
//allowed tags
var tags = ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'h7', 'h8', 'ul', 'ol', 'li', 'u', 'i', 'b', 'a', 'table', 'tr', 'th', 'td', 'img', 'em', 'strong', 'br', 'sup', 'sub'];
...
// ----------------------------------------------------
// -- FCK related commands
My_FCKCleanHtmlCommand.prototype.GetState = function()
{
    return FCK_TRISTATE_OFF; 
}

// Register the related command.
FCKCommands.RegisterCommand('cleantags', new My_FCKCleanHtmlCommand());

// Create the "nbsp" toolbar button.
var cleantagsItem = new FCKToolbarButton("cleantags", FCKLang.CleanTagsButton);
cleantagsItem.IconPath = FCKConfig.PluginsPath + 'CleanTags/cleantags.gif';

// 'nbsp' is the name used in the Toolbar config.
FCKToolbarItems.RegisterItem('cleantags', cleantagsItem);