...
{
    public class UnusedFiles : BaseCmsAdminTool
    {
        public override CmsAdminToolInfo getToolInfo()
        {
            return new CmsAdminToolInfo(CmsAdminToolCategory.Report_Other, AdminMenuTab.Reports, "Unused files");
        }
        ...
        {
            string rootDirName = System.Web.Hosting.HostingEnvironment.MapPath(CmsConfig.UserFilesPath);
